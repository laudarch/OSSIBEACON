...
void beacon_makePacket(uint8_t num)
{
	...
	case 1:
		...
		// erase previous data after data are copied to beaconPacket
		for (i = 0; i < STATUS_DATA_SIZE ; i++)
		{
			obcData[i+STATUS_DATA_ADDR] = 0;
		}
		break;
	case 2:
		// VI DATA PACKET
